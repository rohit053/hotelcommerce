<div class="panel">
	...
	<form id="{$table|escape:'htmlall':'UTF-8'}_form" class="defaultForm {$name_controller|escape:'htmlall':'UTF-8'} form-horizontal" action="{$current|escape:'htmlall':'UTF-8'}&{if !empty($submit_action)}{$submit_action|escape:'htmlall':'UTF-8'}{/if}&token={$token|escape:'htmlall':'UTF-8'}" method="post" enctype="multipart/form-data" {if isset($style)}style="{$style|escape:'htmlall':'UTF-8'}"{/if}>
		...
		<div class="form-group specific_date_type" {if isset($featurePriceInfo->date_selection_type) && $featurePriceInfo->date_selection_type != 2}style="display:none;"{else}style="display:none;"{/if}">
		...
		<div class="form-group date_range_type" {if isset($featurePriceInfo->date_selection_type) && $featurePriceInfo->date_selection_type == 2}style="display:none;"{/if}">
			...
			<div class="col-sm-3">
				<input type="text" id="feature_plan_date_from" name="date_from" class="form-control" value="{if isset($featurePriceInfo->date_from)}{$featurePriceInfo->date_from}{else}{$date_from}{/if}" readonly/>
			</div>
		</div>
		<div class="form-group date_range_type" {if isset($featurePriceInfo->date_selection_type) && $featurePriceInfo->date_selection_type == 2}style="display:none;"{/if}">
			...
			<div class="col-sm-3">
				<input type="text" id="feature_plan_date_to" name="date_to" class="form-control" value="{if isset($featurePriceInfo->date_to)}{$featurePriceInfo->date_to}{else}{$date_to}{/if}" readonly/> 
			</div>
		</div>
		<div class="form-group special_days_content" {if isset($featurePriceInfo->date_selection_type) && $featurePriceInfo->date_selection_type == 2}style="display:none;"{/if}">
			...
			<div class="col-sm-7 week_days" {if isset($featurePriceInfo->is_special_days_exists) && $featurePriceInfo->is_special_days_exists}style="display:block;"{/if}>
				<div class="col-sm-1">
					<input type="checkbox" name="special_days[]" value="mon" {if isset($special_days) && in_array('mon', $special_days)}checked="checked"{/if}/>
					<p>{l s='Mon' mod='hotelreservationsystem'}</p>
				</div>
				<div class="col-sm-1">
					<input type="checkbox" name="special_days[]" value="tue" {if isset($special_days) && in_array('tue', $special_days)}checked="checked"{/if}/>
					<p>{l s='Tue' mod='hotelreservationsystem'}</p>
				</div>
				<div class="col-sm-1">
					<input type="checkbox" name="special_days[]" value="wed" {if isset($special_days) && in_array('wed', $special_days)}checked="checked"{/if}/>
					<p>{l s='Wed' mod='hotelreservationsystem'}</p>
				</div>
				<div class="col-sm-1">
					<input type="checkbox" name="special_days[]" value="thru" {if isset($special_days) && in_array('thr', $special_days)}checked="checked"{/if}/>
					<p>{l s='Thru' mod='hotelreservationsystem'}</p>
				</div>
				<div class="col-sm-1">
					<input type="checkbox" name="special_days[]" value="fri" {if isset($special_days) && in_array('fri', $special_days)}checked="checked"{/if}/>
					<p>{l s='Fri' mod='hotelreservationsystem'}</p>
				</div>
				<div class="col-sm-1">
					<input type="checkbox" name="special_days[]" value="sat" {if isset($special_days) && in_array('sat', $special_days)}checked="checked"{/if}/>
					<p>{l s='Sat' mod='hotelreservationsystem'}</p>
				</div>
				<div class="col-sm-1">
					<input type="checkbox" name="special_days[]" value="sun" {if isset($special_days) && in_array('sun', $special_days)}checked="checked"{/if}/>
